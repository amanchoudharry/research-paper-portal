...
<div class="main-content p-2 bg-purple-100 w-full overflow-hidden min-h-screen">
    <div class="main-content-inner">
        <nav class="p-3" aria-label="breadcrumb">
            <ol class="list-reset flex">
                ...
                <li><span class="mx-2 text-gray-700">/</span></li>
                <li><a href="#" class="text-blue-400 hover:text-blue-700">Reports</a></li>
                <li><span class="mx-2 text-gray-700">/</span></li>
                <li class="text-blue-400">Research Paper</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="flex justify-center p-2 m-5">
        <div class="table-responsive p-2 rounded-md">
            ...
            $sql = "SELECT * FROM researchpapersbyfaculty WHERE status=1";
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<p class="text-gray-800 text-2xl">No Research Paper found.</p><br><p class="text-gray-800 text-md">The entries will appear on the <a href="index1admin.php" class="text-blue-500">Dashboard</a> before approval. After it is approved, it will be visible here.</p>';
            }
