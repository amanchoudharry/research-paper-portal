...
<div class="container  mx-auto p-6 max-w-7xl bg-white rounded-lg shadow-lg">
	...
	<form class="space-y-6" method="post" action="books.php" enctype="multipart/form-data">
		...
		<div id="section1" class="form-section active ">
			...
			<div class="my-10">
				...
				<input required type="text" name="paper_title" id="paper_title" placeholder="Enter Title of Book" class="mt-1 w-full max-w-md px-4 py-2 border rounded-md border-blue-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
			</div>
		...
		<div id="section3" class="form-section">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<div class="mb-4 ">
					<label for="listing" class="block text-sm font-medium text-gray-700">Listing</label>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<div class="mb-6">
					...
					<div class="flex items-center">
						<input required class="form-control date-picker w-full max-w-sm px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" id="publicationdate" name="publicationdate" type="date" data-date-format="yyyy-mm-dd" />
					</div>
				</div>
				<div class="mb-6">
