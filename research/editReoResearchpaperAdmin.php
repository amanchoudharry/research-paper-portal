...
//cheking if dir. to store files is available if not it is being created
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        //header("location: ReoResearchpaper.php?id=".$id);
		echo "<script>";
		echo "alert('Updated Successfully')";
	    echo "location.replace('editReoResearchpaperAdmin.php?id=".$id."')";
	    echo "</script>";
		echo "<script>
								setTimeout(function() {
...
?>
	...
	<form class="space-y-6" method="post" action="editReoResearchpaperAdmin.php" enctype="multipart/form-data">
    ...
    <input type="hidden" name="faculty_scientist" value="<?php echo $row['Faculty']; ?>">
    <input type="hidden" name="employee_id" value="<?php echo $row['Employee ID']; ?>">
			...
			<div class=" my-10">
				...
				<input required type="text" id="Co-author" name="Co-author"value="<?php echo $row['Co-author']; ?>" placeholder="Enter Corresponding author's Name" class="mt-1 w-full max-w-md px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
			</div>

			<div class="my-10">
				<label for="paper-title" class="block text-sm font-medium text-gray-700">Title of Paper<span class="text-red-500">*</span></label>
				<input required type="text" name="papertitle" id="papertitle"value="<?php echo $row['papertitle']; ?>" placeholder="Enter Title of Paper" class="mt-1 w-full max-w-md px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
			</div>
		...
		<div id="section2" class="form-section">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
				...
				<div class="mb-4">
					...
					<input required type="text" name="impact" id="impact-factor" value="<?php echo $row['impact']; ?>" placeholder="Enter Impact Factor" class="mt-1 w-full px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
				</div>
				...
				<div class="mb-4">
					...
					<input type="link" name="link" id="ugc-recognition-link" value="<?php echo $row['link']; ?>" placeholder="Enter UGC Recognition Link" class="mt-1 w-full px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
				</div>
			</div>
		...
		<div id="section3" class="form-section">
			...
			<h4 class="text-lg font-semibold mb-4">Evidence (Upload)</h4>
