...
<html lang="en">
	...
	<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <nav class=" shadow-md sticky top-0 left-0"  style="font-size:13px;">
            <div class="max-w-auto bg-purple-900 mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-14">
                    <div class="flex">
                        <a href="index1admin.php" class="flex items-center">
                            <img src="amity_logo.png" alt="amity-logo" class="h-8 w-8">
                            <span class="ml-3 text-xl font-serif text-gray-100">Amity University Patna</span>
                        </a>
                    </div>
                    ...
                    <ul class="flex space-x-4">
                        <li class="nav-item">
                            <a href="index1admin.php" class="px-4 py-2 text-gray-100 text-lg font-thin hover:bg-gradient-to-b from-purple-900 to-purple-600 rounded-lg flex items-center"  style="font-size:15px;">
                                <i class="fa fa-home mr-2"></i> Home
                            </a>
                        </li>
                        <li class="nav-item relative">
                            <a href="#" class="px-4 py-2 text-gray-100 text-lg font-thin hover:bg-gradient-to-b from-purple-900 to-purple-600 rounded-lg flex items-center"  style="font-size:15px;">
                                <i class="fa fa-list mr-2"></i> View Reports <i class="fa fa-angle-down ml-1"></i>
                            </a>
                            <div class="dropdown-menu rounded-b-lg">
                                <a href="ReoResearchpaperAdmin.php"><i class="fa fa-file-text mr-2"></i> Research Papers</a>
                                <a href="ReochaptersAdmin.php"><i class="fa fa-book mr-2"></i> Chapters</a>
                                <a href="ReopapersAdmin.php"><i class="fa fa-file-powerpoint mr-2"></i> Conference Paper</a>
                                <a href="ReoBooksAdmin.php"><i class="fa fa-book-open mr-2"></i> Books Published</a>
                            </div>
                        </li>
                        <li class="nav-item relative">
                        ...
                        <button @click="open = !open" class="flex items-center focus:outline-none">
                            ...
                            ?>
                            <span class="ml-2 text-gray-100">Welcome<br> <b><?php echo $_SESSION['user_name'] ?></b>,
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-md overflow-hidden" x-cloak>
                            ...
                            <a href="profileAdmin.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200">Profile</a>
        ...
        <div class="flex-container max-w-full min-h-screen">
