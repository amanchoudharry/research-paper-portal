						...
						<a href="calendar.html">
							...
							<span class="menu-text">
								...
								<span class="badge badge-transparent tooltip-error" title="2 Important Events">
									<i class="ace-icon fa fa-exclamation-triangle red bigger-130"></i>								</span>							</span>						</a>
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							...
							<span class="menu-text">
								...
								<span class="badge badge-primary">5</span>							</span>
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Common form elements and layouts								</small>							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									...
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Text Field </label>			                                    <div class="col-sm-9">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">Inline help text</span>											</span>										</div>
									</div>
										...
										<div class="col-sm-9">
											...
											<span class="help-inline col-xs-12 col-sm-7">
												<label class="middle">
													...
													<span class="lbl"> Disable it!</span>												</label>
											</span>										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="input-icon">
												...
												<i class="ace-icon fa fa-leaf blue"></i>											</span>

											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" />
												<i class="ace-icon fa fa-leaf green"></i>											</span>										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="More details." title="Popover on hover">?</span>										</div>
									</div>
												...
												<div class="widget-header">
													...
													<div class="widget-toolbar">
														...
														<a href="#" data-action="close">
															<i class="ace-icon fa fa-times"></i>														</a>													</div>
												</div>
												...
												<div class="widget-header">
													...
													<span class="widget-toolbar">
														<a href="#" data-action="settings">
															<i class="ace-icon fa fa-cog"></i>														</a>
														...
														<a href="#" data-action="close">
															<i class="ace-icon fa fa-times"></i>														</a>													</span>												</div>
													...
													<div class="widget-main">
														<div>
															<label for="form-field-mask-1">
																Date
																<small class="text-success">99/99/9999</small>															</label>
														...
														<div>
															<label for="form-field-mask-2">
																Phone
																<small class="text-warning">(999) 999-9999</small>															</label>
														...
														<div>
															<label for="form-field-mask-3">
																Product Key
																<small class="text-error">a*-999-a999</small>															</label>

															<div class="input-group">
																<input class="form-control input-mask-product" type="text" id="form-field-mask-3" />
																<span class="input-group-addon">
																	<i class="ace-icon fa fa-key"></i>																</span>															</div>
														</div>
														...
														<div>
															<label for="form-field-mask-4">
																Eye Script
																<small class="text-info">~9.99 ~9.99 999</small>															</label>
												...
												<div class="widget-body">
													<div class="widget-main">
														...
														<div>
															<div class="row">
																<div class="col-sm-6">
																	<span class="bigger-110">Multiple</span>																</div><!-- /.span -->
									...
									<h3 class="header smaller lighter blue">
										Checkboxes & Radio
										<small>All Checkboxes, Radios and Switch Buttons Are Pure CSS</small>									</h3>
											...
											<div class="control-group">
												...
												<div class="checkbox">
													<label>
														...
														<span class="lbl"> choice 1</span>													</label>
												</div>

												<div class="checkbox">
													<label>
														<input name="form-field-checkbox" type="checkbox" class="ace" />
														<span class="lbl"> choice 2</span>													</label>
												</div>

												<div class="checkbox">
													<label>
														<input name="form-field-checkbox" class="ace ace-checkbox-2" type="checkbox" />
														<span class="lbl"> choice 3</span>													</label>
												</div>

												<div class="checkbox">
													<label class="block">
														<input name="form-field-checkbox" disabled="" type="checkbox" class="ace" />
														<span class="lbl"> disabled</span>													</label>
												</div>

												<div class="checkbox">
													<label class="block">
														<input name="form-field-checkbox" type="checkbox" class="ace input-lg" />
														<span class="lbl bigger-120"> large checkbox</span>													</label>
												</div>
											</div>
										</div>
											...
											<div class="control-group">
												...
												<div class="radio">
													<label>
														...
														<span class="lbl"> radio option 1</span>													</label>
												</div>

												<div class="radio">
													<label>
														<input name="form-field-radio" type="radio" class="ace" />
														<span class="lbl"> radio option 2</span>													</label>
												</div>

												<div class="radio">
													<label>
														<input name="form-field-radio" type="radio" class="ace" />
														<span class="lbl"> radio option 3</span>													</label>
												</div>
												...
												<div class="radio">
													<label>
														...
														<span class="lbl bigger-120"> large radio</span>													</label>
												</div>
											</div>
										</div>
									</div><!-- /.row -->
										...
										<div class="controls col-xs-12 col-sm-9">
											<div class="row">
												...
												<div class="col-xs-3">
													<label>
														<input name="switch-field-1" class="ace ace-switch" type="checkbox" />
														<span class="lbl" data-lbl="CUS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOM"></span>													</label>
												</div>
											</div>
												...
												<div class="widget-body">
													<div class="widget-main">
														...
														<label>
															...
															<span class="lbl"> Allow only images</span>														</label>
													</div>
												</div>
											</div>
										</div>
														...
														<div class="row">
															...
															<div class="col-xs-9 col-md-10">
																<div id="slider-eq">
																	...
																	<span class="ui-slider-simple ui-slider-dark">88</span>																</div>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="widget-body">
													<div class="widget-main">
														...
														<div class="input-group bootstrap-timepicker">
															...
															<span class="input-group-addon">
																<i class="fa fa-clock-o bigger-110"></i>															</span>														</div>
								...
								<h4 class="pink">
									...
									<a href="#modal-form" role="button" class="blue" data-toggle="modal"> Form Inside a Modal Box </a>								</h4>
													...
													<form>
														...
														<fieldset>
															...
															<label class="pull-right">
																...
																<span class="lbl"> check me out</span>															</label>
														</fieldset>
												...
												<div class="widget-main">
													<form class="form-inline">
														...
														<button type="button" class="btn btn-info btn-sm">
															<i class="ace-icon fa fa-key bigger-110"></i>Login														</button>
													</form>
												</div>
											</div>
										</div>
