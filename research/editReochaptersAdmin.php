...
if (isset($_GET['id']) && !empty(trim($_GET['id']))) {
    ...
    $sql = "SELECT * FROM bookchaptersbyfaculty WHERE srNo = ?";
...
<div class="container  mx-auto p-6 max-w-7xl bg-white rounded-lg shadow-lg">
	...
	<form class="space-y-6" method="post" action="editReochaptersAdmin.php" enctype="multipart/form-data">
    ...
    <input type="hidden" name="emp_id" value="<?php echo $row['Employee ID']; ?>">
			...
			<div class="my-10">
				<label for="booktitle" class="block text-sm font-medium text-gray-700">Title of Book Chapter<span class="text-red-500">*</span></label>
				<input required type="text" name="booktitle" id="booktitle" value="<?php echo $row['booktitle']; ?>" placeholder="Enter Title of Chapter"  class="mt-1 w-full max-w-md px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
			</div>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				<!-- Volume/Edition -->
				<div class="mb-4">
					<label for="volume" class="block text-sm font-medium text-gray-700">Volume/Edition<span class="text-red-500">*</span></label>
					<input required type="number" name="volume" id="volume" value="<?php echo $row['volume']; ?>" placeholder="Enter Volume/Edition" class="mt-1 w-full px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
				</div>
