...
<div class="main-content p-2 bg-purple-100 w-full overflow-hidden min-h-screen">
    ...
    <div class="flex justify-center p-2 m-5">
        <div class="table-responsive p-2 rounded-md">
            ...
            $sql = "SELECT * FROM booksbyfaculty WHERE status=1";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td class="border px-4 py-2 text-center"><a href="editReoBooksAdmin.php?id=' . $row['srNo'] . '" class="btn-icon edit"><i class="fas fa-edit"></i></a></td>';
                ...
                echo '<p class="text-gray-800 text-2xl">No Books found.</p><br><p class="text-gray-800 text-md">The entries will appear on the <a href="index1admin.php" class="text-blue-500">Dashboard</a> before approval. After it is approved, it will be visible here.</p>';
            }
