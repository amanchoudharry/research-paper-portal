...
<div class="container  mx-auto p-6 max-w-7xl bg-white rounded-lg shadow-lg">
	...
	<form class="space-y-6" method="post" action="Papers.php" enctype="multipart/form-data">
		...
		<div id="section1" class="form-section active ">
			...
			<div class="my-10">
				...
				<input required type="text" name="booktitle" id="booktitle" placeholder="Enter Title of Paper" class="mt-1 w-full max-w-md px-4 py-2 border rounded-md border-blue-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
			</div>

			<div class="my-10">
				<label for="journal-name" class="block text-sm font-medium text-gray-700">Name of Journal<span class="text-red-500">*</span></label>
				<input required type="text" name="journal_name" id="journal-name" placeholder="Enter Name of Journal" class="mt-1 w-full max-w-md px-4 py-2 border rounded-md border-blue-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
			</div>
		...
		<div id="section2" class="form-section">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
				...
				<div class="mb-4">
					...
					<input required type="text" name="conferenceName" id="conferenceName" placeholder="Enter Research confrence" class="mt-1 w-full max-w-sm px-4 py-2 border rounded-md border-blue-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
				</div>
				...
				<div class="mb-4">
					...
					<input required type="text" name="conferencePaper" id="conferencePaper" placeholder="Enter Conference Paper" class="mt-1 w-full max-w-sm px-4 py-2 border rounded-md border-blue-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
				</div>
				<!-- Publisher Name -->
				<div class="mb-4">
	...
	<!-- Listed in Scopus -->
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<div class="mb-4">
					...
					<input required type="text" name="impact" id="impact-factor" placeholder="Enter Impact Factor" class="mt-1 w-full max-w-xs px-4 py-2 border rounded-md border-blue-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
				</div>
				</div>
