...
<div class="main-content min-h-screen p-2 bg-blue-100 w-full overflow-hidden">
    ...
    <div class="flex justify-center p-2 m-5">
        <div class="table-responsive p-2 rounded-md">
            ...
            $sql = "SELECT * FROM researchpapersbyfaculty WHERE `Employee ID` = '$emp_id' and status=1";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td class="border px-4 py-2 text-center">
                            <a href="editReoResearchpaper.php?id=' . $row['srNo'] . '" class="btn-icon edit">
                ...
                echo '<p class="text-gray-800 text-2xl">No research papers found.</p><br><p class="text-gray-800 text-md">Once submitted, your entry will appear on the <a href="index1.php" class="text-blue-500">Dashboard</a> before approval. After it is approved, it will be visible here.</p>';
            }
