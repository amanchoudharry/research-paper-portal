...
<div class="main-content p-2 bg-purple-100 w-full overflow-hidden min-h-screen">
    <div class="main-content-inner">
        <nav class="p-3" aria-label="breadcrumb">
            <ol class="list-reset flex">
                ...
                <li class="text-blue-400">Chapters</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="flex justify-center p-2 m-5">
        <div class="table-responsive p-2 rounded-md">
            ...
            $sql = "SELECT * FROM bookchaptersbyfaculty WHERE status=1";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td class="border px-4 py-2 text-center"><a href="editReochaptersAdmin.php?id=' . $row['srNo'] . '" class="btn-icon edit"><i class="fas fa-edit"></i></a></td>';
                ...
                echo '<p class="text-gray-800 text-2xl">No Chapters found.</p><br><p class="text-gray-800 text-md">The entries will appear on the <a href="index1admin.php" class="text-blue-500">Dashboard</a> before approval. After it is approved, it will be visible here.</p>';
            }
